...
public:
  PLUGININFORMATION("ProteinCraftInteractorParallelCoordsSelection", "Tulip Team", "02/04/2009",
...
public:
  PLUGININFORMATION("ProteinCraftInteractorHighLiter", "Tulip Team", "02/04/2009",
...
public:
  PLUGININFORMATION("ProteinCraftInteractorAxisSwapper", "Tulip Team", "02/04/2009", "Axis Swap Interactor",
                    "1.0", "Modification")
...
public:
  PLUGININFORMATION("ProteinCraftInteractorAxisSliders", "Tulip Team", "02/04/2009", "Axis Sliders Interactor",
                    "1.0", "Modification")
...
public:
  PLUGININFORMATION("ProteinCraftInteractorBoxPlot", "Tulip Team", "02/04/2009", "Box Plot Interactor", "1.0",
                    "Information")
...
public:
  PLUGININFORMATION("ProteinCraftInteractorShowElementInfo", "Tulip Team", "02/04/2009", "Explore current view",
                    "2.0", "Information")
  /**
   * Default constructor
   */
...
public:
  PLUGININFORMATION("ProteinCraftInteractorAxisSpacer", "Tulip Team", "02/04/2009", "Axis Spacer Interactor",
                    "1.0", "Modification")
